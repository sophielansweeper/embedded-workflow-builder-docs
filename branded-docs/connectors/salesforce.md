...
- When you create your "Connected App" be sure to check **Enable OAuth Settings**, and enter the OAuth callback URL `https://oauth2.Lansweeper.com/callback` as a **Callback URL**.
